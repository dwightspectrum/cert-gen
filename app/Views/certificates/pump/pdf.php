...
<body>
    ...
    <table>
        <tr>
            <td>
                <img src="<?=FCPATH . '/assets/img/pump.png' ?>" height="95%" width="37%" >
            </td>
            <td>
                <table>
                    <?php $ventilator_data = json_decode($pump['image_data']); ?>
                            ...
                            <tr>
                                ...
                                <?php if ($key === 0): ?>
                                    <td style="border: 1px dotted black; text-align: center;" rowspan="<?= count($v->data) ?>">
                                        <img src="<?=FCPATH . '/assets/img/signatures/' . $pump['signatures'] ?>" width="100">
                                    </td>
    ...
    <table>
        <?php 
            $verify_data = json_decode($pump['verified_place']);
    ...
    <table style="border-top: 1px solid black; border-right: 1px solid black; border-left: 1px solid black;">
        ...
        <tr>
            ...
            <?php $isolation = json_decode($pump['isolation']); ?>
        ...
        <tr>
            <td colspan="2" style="width: 50%; border-bottom: 2px solid black;">
                ...
                <span style="text-align: center; font-size: 1.2em;">
                    <?=$pump['inspector'] == 'null' ? '<br><br><br><br>' : $pump['inspector'] ?>
                </span>
            </td>
            <td rowspan="2" style="width: 50%; border-left: 2px solid black; text-align: center;">
                <img src="<?=FCPATH . '/assets/img/signatures/' . $pump['signatures'] ?>" width="30%">
            </td>
        </tr>
        <tr>
            <td style="width: 25%; ">
                ...
                <div style="text-align: center; font-size: 1.2em;">
                    <?=$pump['place'] == 'null' ? '<br><br><br>' : $pump['place'] ?>
                </div>
            </td>
