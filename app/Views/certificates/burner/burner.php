  ...
  <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-center justify-content-between mb-3">
          <h5 class="card-title">Maintenance Burner</h5>
          <div>
            <button type="button" class="btn btn-success " id="saveButton"><i class="bi bi-save"></i> Save</button>
          </div>
        </div>      
...
<script>
  const SERIAL_NUMBER = <?= json_encode($serial) ?>
</script>
...
<script src="<?=base_url()?>/assets/js/burner/burner.js"></script>
